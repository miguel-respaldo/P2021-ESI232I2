...
Funcion mostrar_carrito (l_productos,l_precios,c_productos,c_cantidad)
	Escribir '--------  Carrito  ----------'
...
Funcion agregar_al_carrito (l_productos,l_precios,c_productos,c_cantidad)
	tamano <- 5
	...
	SiNo
		cantidad <- cantidad+1
		c_productos[cantidad] <- num_producto
		c_cantidad[cantidad] <- cant_producto
	FinSi
FinFuncion
...
Algoritmo tiendita
	...
	Mientras opcion_menu<>6 Hacer
		...
		Segun opcion_menu  Hacer
			...
			3:
				agregar_al_carrito(lista_productos,lista_precios,carrito_producto,carrito_cantidad)
			6:
